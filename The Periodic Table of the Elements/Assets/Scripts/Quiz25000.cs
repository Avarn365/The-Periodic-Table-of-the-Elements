...
public class Quiz25000 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (randomQuestion == 1)
        {
            QuestionText.text = "Zirconium's density is less than 7 grams per cubic centimeter.";
            correctAnswer = "true";
        }
        ...
        {
            QuestionText.text = "Seaborgium is an alkali metal.";
            correctAnswer = "false";
        }
    ...
    void Update()
    {
        ...
        {
            SubtitleText.text = "Incorrect. It is " + correctAnswer + ". You win $10,000.";
